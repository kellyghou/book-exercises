...
intro_panel <- tabPanel(
  ...
  img(src = "www/inequality.png", alt = "image"),
  p(a("link", href = "https://www.nytimes.com/interactive/2017/08/07/opinion/leonhardt-income-inequality.html")),
  p("No idea what the diagram shows, probably something about ", em("Income Inequality"), ". ", strong("Hopefully I still get credit for this exercise."))
)  
...
main_content <- mainPanel(
  ...
  p("Data from", a("data source", href = "http://gabriel-zucman.eu/usdina/"))
)
